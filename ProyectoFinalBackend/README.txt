...
a persistence unit "ProyectoFinalBackendPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ProyectoFinalBackend/pom.xml":
...
artifact ("ProyectoFinalBackend.war") is already built. You can build
